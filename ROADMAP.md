...
- [x] 1,181 → 1,446 tests (1,446 local + 56 Docker CI), 91.7% line coverage (llvm-cov), 0 clippy warnings, 0 doc warnings, 0 unsafe, 0 fmt issues
...
- [x] Coverage target: 90%+ with llvm-cov *(91.7% line coverage, 1,446 tests)*
