...
v0.7.36 | 1,549 tests | 91.7% coverage | Edition 2024 | scyBorg Triple-Copyleft | Pure Rust | ecoBin A++ | BTSP enforced on TCP | Wire L3 | Stadial ready | 37 methods + 10 aliases | JH-0 method gate | BearDog crypto delegation | JH-5 audit pipeline | NFT seal verified
