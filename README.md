...
v0.7.27 | 1,454 tests | 91.7% coverage | Edition 2024 | scyBorg Triple-Copyleft | Pure Rust | ecoBin compliant | BTSP Phase 2 | Wire L3 | Stadial parity (zero async-trait, zero dyn dispatch, sled eliminated, libsqlite3-sys eliminated, BTSP first-line auto-detect, PG-52 EOF-resilient UDS)
...
| BTSP | Phase 2 — `detect_protocol` three-way multiplexer (EOF-resilient, PG-52) when `FAMILY_ID` set |
