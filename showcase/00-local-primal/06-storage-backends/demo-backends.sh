...
echo -e "${GREEN}   ./sweet-grass-service --storage memory${NC}"
echo ""
echo -e "${BLUE}   # Sled backend (embedded, Pure Rust)${NC}"
echo -e "${GREEN}   ./sweet-grass-service --storage sled --sled-path ./data${NC}"
echo ""
echo -e "${BLUE}   # PostgreSQL backend (production)${NC}"
echo -e "${GREEN}   export DATABASE_URL=postgresql://localhost/sweetgrass${NC}"
echo -e "${GREEN}   ./sweet-grass-service --storage postgres${NC}"
echo ""
