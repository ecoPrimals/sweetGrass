...
echo ""
echo "Next steps:"
echo "  - Level 0 (Local Primal): cd showcase/00-local-primal"
echo "  - Level 1 (Coordination): cd showcase/01-primal-coordination"
echo "  - Level 2 (Ecosystem):    cd showcase/02-full-ecosystem"
echo ""
