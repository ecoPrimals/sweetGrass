...
- **Tests:** 1,573 local + 56 Docker CI (cargo test --all-features)
...
- **Source files:** 194 `.rs` files (56,673 LOC), max 763 lines (all files under 800-line threshold)
...
39 semantic methods across 12 domains:
