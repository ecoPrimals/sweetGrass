...
//! Braid domain handlers: create, get, `get_by_hash`, query, delete, commit, anchor, list.
//!
//! See also: [`super::braid_batch`] (batch ops), [`super::braid_verify`] (atomic verify).
...
pub(super) fn default_spine_id() -> String {
    "default".to_string()
}
