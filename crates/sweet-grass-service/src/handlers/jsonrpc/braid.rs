...
//! verify, `batch_create`, `batch_commit`.
...
/// (10× faster than sequential `braid.create` calls at ~30ms/object).
...
/// hash, and delegates verification to bearDog. Falls back to "presence only"
/// if the crypto delegate is unavailable.
