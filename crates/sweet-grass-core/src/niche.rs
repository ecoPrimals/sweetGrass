...
pub fn operation_dependencies() -> Vec<OperationMeta> {
    vec![
        ...
        OperationMeta::new("braid.list", &[], "medium", 10),
        OperationMeta::new("braid.verify", &["braid.create"], "medium", 20),
        OperationMeta::new("braid.delete", &[], "low", 2),
        OperationMeta::new("braid.commit", &["braid.create"], "medium", 15),
        OperationMeta::new("braid.anchor", &["braid.create"], "medium", 20),
        OperationMeta::new("braid.batch_create", &[], "medium", 30),
        OperationMeta::new("braid.batch_commit", &["braid.batch_create"], "medium", 40),
        OperationMeta::new("convergence.check", &["braid.create"], "low", 5),
        OperationMeta::new("convergence.batch_check", &["braid.create"], "medium", 20),
        OperationMeta::new("convergence.pressure", &["braid.create"], "medium", 15),
        ...
        OperationMeta::new("contribution.record_provenance", &[], "medium", 10),
        ...
        OperationMeta::new("capability.call", &[], "low", 5),
        ...
        OperationMeta::new("rootpulse.attribute", &["braid.create"], "medium", 20),
        OperationMeta::new("rootpulse.query", &[], "medium", 15),
        OperationMeta::new("trust.event", &["braid.create"], "medium", 5),
...
pub const DOMAIN_DESCRIPTIONS: &[(&str, &str)] = &[
    ...
    ("convergence", "Provenance chain verification (trust gate)"),
...
pub fn semantic_mappings() -> Vec<(&'static str, &'static str)> {
    vec![
        ...
        ("is data converged", "convergence.check"),
        ("batch convergence check", "convergence.batch_check"),
        ("convergence pressure", "convergence.pressure"),
        ("should I throttle", "convergence.pressure"),
        ("list braids", "braid.list"),
        ("enumerate braids", "braid.list"),
        ("verify braid", "braid.verify"),
        ("check braid integrity", "braid.verify"),
